      ...
      <div className="container mx-auto px-6 py-10 flex-grow">
        ...
        {applications.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 mt-1 text-sm">Apply to jobs to see them listed here.</p>
          </div>
        ) : (
          <div className="flex flex-col gap-5">
            {applications.map((app) => (
              ...
              >
                ...
                {/* API မှာ job_title / employer_company တွေ မပါလို့ job id နဲ့ cover letter, status ကိုပြထား */}
                <h3 className="text-[16px] font-semibold">Job ID: {app.job}</h3>
                ...
                <p className="text-sm text-gray-700 mt-2">
                  Cover letter: {app.cover_letter_text || "—"}
                </p>
