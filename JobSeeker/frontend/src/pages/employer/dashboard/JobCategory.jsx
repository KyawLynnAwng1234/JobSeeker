        ...
        <ul className="space-y-2">
          {categories.length > 0 ? (
            categories.map((cat) => (
              <li
                key={cat.id}
                className="px-4 py-2 rounded-md border border-gray-200 shadow-sm flex justify-between items-center"
              >
                <span>{cat.name}</span>
                <span className="text-gray-400 text-sm">#{cat.id}</span>
              </li>
            ))
          ) : (
